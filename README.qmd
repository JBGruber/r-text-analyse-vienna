...
I assume that you have [R]() and [RStudio]() installed and have some basic knowledge of R.
If that is not the case, you can also use this workshop to get an overview of available approaches.
But you will have a harder time following what's going on in the sessions.
